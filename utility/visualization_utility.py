...
def plot_scatter(ax, X, Y, x_label, y_label, title, legend_loc=4, label_dict=False, legend_size=7, legend_col=1, color_schemes_idx=1):
    ...
    plt.yticks([])
    ax.set_title(title)
    ax.legend(loc=legend_loc, prop={'size': legend_size},ncol=legend_col, edgecolor='black', facecolor='white', frameon=True)
    matplotlib.rcParams['mathtext.fontset'] = 'stix'
    matplotlib.rcParams['font.family'] = 'STIXGeneral'
    matplotlib.rcParams['mathtext.fontset'] = 'custom'
    matplotlib.rcParams['mathtext.rm'] = 'Bitstream Vera Sans'
